...
import { useCancellationReason_DeleteMutation } from 'src/graphql/generated';
...
const Index: FC<IPageProps> = ({ DataRow, OnhandleEditClick, onRefreshItem }) => {
	...
	const { mutate: mutateState, isLoading: isLoading } = useCancellationReason_DeleteMutation();
