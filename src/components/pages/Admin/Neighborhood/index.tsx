...
import { useNeighborhood_GetAllQuery } from 'src/graphql/generated';
...
const Index = () => {
	...
	const {
		...
		isError,
		error,
	} = useNeighborhood_GetAllQuery(
		{
			take: 1000,
			skip: 0,
			where: { city: { id: { eq: SearchData } } },
		},
		{
	...
	return (
		<>
			...
			<MidelForm
				DataRow={CityList?.neighborhood_getAll?.result?.items}
